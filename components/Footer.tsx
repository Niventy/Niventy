...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-dark-950 text-slate-300 pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-6">
        {/* Big brand name */}
        <div className="mb-16">
          <p className="text-7xl md:text-9xl font-display font-bold tracking-display text-accent-500">NIVENTY</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-dark-800 flex items-center justify-center hover:bg-accent-500 transition-colors">
                <Linkedin size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-dark-800 flex items-center justify-center hover:bg-accent-500 transition-colors">
                <Instagram size={20} />
          ...
          <div>
            ...
            <div className="p-4 bg-dark-800 rounded-xl border border-slate-700">
               <p className="text-sm text-white font-medium mb-2">Prêt à scaler ?</p>
               <button className="w-full py-2 bg-accent-500 hover:bg-accent-600 text-white rounded-lg text-sm font-semibold transition-colors">
                  Réserver un appel
               </button>
            </div>
          </div>
        ...
        <div className="border-t border-dark-800 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-slate-500">
