...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-niventy-500 text-white border border-niventy-400 shadow-[0_0_15px_rgba(236,72,153,0.3)] hover:shadow-[0_0_25px_rgba(236,72,153,0.5)] hover:bg-niventy-600",
